...
// @namespace           杀佛观音
// @version             0.3.11
// @description         【安全无劫持、全平台设备兼容、无广告、无优惠券内容、无公众号限制】兼容电脑、手机、平板；兼容iOS、iPadOS快捷指令；兼容任意支持脚本扩展的浏览器，并提供去广告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、爱奇艺、哔哩哔哩、风行、华数、乐视、芒果TV、咪咕视频、PP视频(PPTV)、搜狐、腾讯视频、土豆、西瓜、优酷VIP视频破解免费看、非VIP视频去广告(视频前广告、视频中途广告、视频暂停广告、水印)；支持悬浮球操作、快捷键操作(并行不悖)；支持更换解析网站地址、关闭去广告功能、切换悬浮球大小、隐藏悬浮球、移动悬浮球。
// @description:zh      【安全无劫持、全平台设备兼容、无广告、无优惠券内容、无公众号限制】兼容电脑、手机、平板；兼容iOS、iPadOS快捷指令；兼容任意支持脚本扩展的浏览器，并提供去广告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、爱奇艺、哔哩哔哩、风行、华数、乐视、芒果TV、咪咕视频、PP视频(PPTV)、搜狐、腾讯视频、土豆、西瓜、优酷VIP视频破解免费看、非VIP视频去广告(视频前广告、视频中途广告、视频暂停广告、水印)；支持悬浮球操作、快捷键操作(并行不悖)；支持更换解析网站地址、关闭去广告功能、切换悬浮球大小、隐藏悬浮球、移动悬浮球。
// @description:zh-CN   【安全无劫持、全平台设备兼容、无广告、无优惠券内容、无公众号限制】兼容电脑、手机、平板；兼容iOS、iPadOS快捷指令；兼容任意支持脚本扩展的浏览器，并提供去广告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、爱奇艺、哔哩哔哩、风行、华数、乐视、芒果TV、咪咕视频、PP视频(PPTV)、搜狐、腾讯视频、土豆、西瓜、优酷VIP视频破解免费看、非VIP视频去广告(视频前广告、视频中途广告、视频暂停广告、水印)；支持悬浮球操作、快捷键操作(并行不悖)；支持更换解析网站地址、关闭去广告功能、切换悬浮球大小、隐藏悬浮球、移动悬浮球。
// @description:zh-TW   【安全無劫持、全平臺設備兼容、無廣告、無優惠券內容、無公眾號限製】兼容電腦、手機、平板；兼容iOS、iPadOS快捷指令；兼容任意支持腳本擴展的瀏覽器，並提供去廣告教程；兼容TM篡改猴、VM暴力猴、GM油猴插件。支持1905、AcFun、愛奇藝、嗶哩嗶哩、風行、華數、樂視、芒果TV、咪咕視頻、PP視頻(PPTV)、搜狐、騰訊視頻、土豆、西瓜、優酷VIP視頻破解免費看、非VIP視頻去廣告(視頻前廣告、視頻中途廣告、視頻暫停廣告、水印)；支持懸浮球操作、快捷鍵操作(並行不悖)；支持更換解析網站地址、關閉去廣告功能、切換懸浮球大小、隱藏懸浮球、移動懸浮球。
// @author              杀佛观音
